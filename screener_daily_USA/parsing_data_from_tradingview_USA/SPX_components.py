...
from ..models import SPX_Components
...
def SPX_components_get_stock_data():
    ...
    if stock_data:
        ...
        SPX_Components.objects.all().delete()

        with transaction.atomic():  
            SPX_Components.objects.bulk_create(stock_objects)

        print("Данные SPX_Components успешно сохранены в базу данных.")
    else:
